...
MdFilledButton.styles = [styles$T, styles$U, styles$V];
...
MdOutlinedButton.styles = [styles$T, styles$S];
...
MdTonalButton.styles = [styles$T, styles$U, styles$Q];
...
MdCheckbox.styles = [styles$P, styles$O];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$K = i$4 `:host{display:flex;flex-wrap:wrap;gap:8px}.content{display:flex;flex-wrap:inherit;gap:inherit}/*# sourceMappingURL=chip-set-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$H = i$4 `.trailing.action{align-items:center;justify-content:center;padding:0 8px;--md-focus-ring-shape-start-start: var(--_container-shape-start-end);--md-focus-ring-shape-end-start: var(--_container-shape-end-end);--md-focus-ring-shape-end-end: var(--_container-shape-end-end);--md-focus-ring-shape-start-end: var(--_container-shape-start-end);--md-focus-ring-outward-offset: -2px}.trailing.action md-ripple{border-radius:50%;height:calc(1.3333333333*var(--_icon-size));width:calc(1.3333333333*var(--_icon-size))}:has(.trailing.action) .primary.action{padding-inline-end:0}.trailing.icon{color:var(--_trailing-icon-color);height:var(--_icon-size);width:var(--_icon-size)}:hover .trailing.icon{color:var(--_hover-trailing-icon-color)}:focus .trailing.icon{color:var(--_focus-trailing-icon-color)}:active .trailing.icon{color:var(--_pressed-trailing-icon-color)}.disabled .trailing.icon{color:var(--_disabled-trailing-icon-color);opacity:var(--_disabled-trailing-icon-opacity)}.selected .trailing.icon{color:var(--_selected-trailing-icon-color)}.selected:hover .trailing.icon{color:var(--_selected-hover-trailing-icon-color)}.selected:focus .trailing.icon{color:var(--_selected-focus-trailing-icon-color)}.selected:active .trailing.icon{color:var(--_selected-pressed-trailing-icon-color)}/*# sourceMappingURL=trailing-icon-styles.css.map */
`;
...
MdInputChip.styles = [styles$L, styles$H, styles$I, styles$G];
...
MdOutlinedIconButton.styles = [styles$t, styles$r];
...
MdStandardIconButton.styles = [styles$t, styles$q];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$o = i$4 `:host{--_container-color: var(--md-list-container-color, var(--md-sys-color-surface, #fef7ff));color:unset}.md3-list{background-color:var(--_container-color);border-radius:inherit;display:block;list-style-type:none;margin:0;min-width:inherit;outline:none;padding:8px 0;position:relative}/*# sourceMappingURL=list-styles.css.map */
`;
...
MdListItem.styles = [styles$m, styles$n];
...
MdListItemLink.styles = [styles$m, styles$n];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$l = i$4 `@media(forced-colors: active){.menu{border-style:solid;border-color:CanvasText;border-width:1px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdMenu.styles = [styles$k, styles$l];
MdMenu = __decorate([
    e$a('md-menu')
], MdMenu);
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$i = i$4 `:host{--_list-item-selected-container-color: var(--md-menu-item-list-item-selected-container-color, var(--md-sys-color-surface-container-highest, #e6e0e9));--_list-item-container-color: var(--md-menu-item-list-item-container-color, var(--md-sys-color-surface-container, #f3edf7));--md-list-item-list-item-container-color: var(--_list-item-container-color)}:host([selected]) .list-item{background-color:var(--_list-item-selected-container-color)}.list-item:has(.submenu:hover){--md-ripple-hover-opacity: 0}/*# sourceMappingURL=menu-item-styles.css.map */
`;
...
MdMenuItem.styles = [styles$m, styles$i, styles$n, styles$j];
...
MdMenuItemLink.styles = [styles$m, styles$i, styles$n, styles$j];
...
MdSelectOption.styles = [styles$m, styles$i, styles$n, styles$j];
